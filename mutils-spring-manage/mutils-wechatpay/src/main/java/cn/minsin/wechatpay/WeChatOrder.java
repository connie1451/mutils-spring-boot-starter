...
public class WeChatOrder {
	...
	public static Map<String, String> getPayNo(String url, String xmlParam) {
		...
		CloseableHttpClient httpclient = HttpClientFactory.getSSLInstance(false,WeixinConfig.PARTNER,WeixinConfig.certificatePath,WeixinConfig.certificateFormat);// 先初始化;
		...
		try {
			...
			httpclient.close();
			Map<String, String> doXMLParse = doXMLParse(jsonStr);
			return WeixinConfig.createAppPayParamter(doXMLParse);
		} catch (Exception e) {
