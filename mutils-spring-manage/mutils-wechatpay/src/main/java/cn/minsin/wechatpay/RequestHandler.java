...
public class RequestHandler {
	 ...
	 * 创建md5摘要,规则是:按参数名称a-z排序,遇到空值的参数不参加签名。
	 */
	public String createRepaySign(SortedMap<String, String> packageParams) {
		StringBuffer sb = new StringBuffer();
		Set es = packageParams.entrySet();
		Iterator it = es.iterator();
		while (it.hasNext()) {
		...
		String sign = MD5Util.MD5Encode(finalStr.substring(0, finalStr.length() - 1), "utf-8").toUpperCase();
		System.out.println("packge签名:" + sign);
		return sign;
